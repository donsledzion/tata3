                        ...
                        <div class="md:mt-6">
                            ...
                            <form method="POST" action="{{ route('posts.store') }}" class="mt-8" enctype="multipart/form-data">
                                <div class="mx-auto max-w-lg ">
                                    ...
                                    <span class="px-1 text-sm text-gray-600">Foto z wydarzenia</span>
                                    ...
                                    <div class="py-1">
                                        <span class="px-1 text-sm text-gray-600">Data cytatu</span>
                                        <input id="said_at" name="said_at" type="date" value="{{ old('said_at', $said_at) }}"
                                               class="text-md block px-3 py-2 rounded-lg w-full
                                                bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"/>
                                    </div>

                                    <span class="px-1 text-sm text-gray-600">Widoczność cytatu</span>
