                    ...
                    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div class="flex p-4 border-t border-gray-300 text-gray-700">
                            <div class="flex-1 inline-flex items-center">
                                ...
                                <a href="{{ route('postsFeed.byKid',$kid) }}">
                        ...
                        <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                            <div class="text-xs uppercase font-bold text-gray-600 tracking-wide">{{__('kidbook.account.account')}}</div>
                            <div class="flex items-center pt-2">
                                <div class="bg-cover bg-center w-10 h-10 rounded-full mr-3" style="background-image: url({{ asset('storage/'.$kid->account->id.'/480/' . $kid->account->avatar) }})">
                                </div>
                                <div>
                                    <p class="font-bold text-gray-900"><a href="{{ route('accounts.show',$kid->account_id) }}">{{$kid->account->name}}</a></p>
                                    <p class="text-sm text-gray-700">{{__('kidbook.kid.kids')}}: {{App\Models\Account::find($kid->account_id)->kids->count()}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
