                        ...
                        <div class="md:mt-6">
                            ...
                            <form method="POST" action="{{ route('kids.update',$kid->id) }}" class="mt-8" enctype="multipart/form-data">
                                <div class="mx-auto max-w-lg ">
                                    ...
                                    <div class="py-1">
                                        <span class="px-1 text-sm text-gray-600">{{__('kidbook.kid.nickname')}} {{__('kidbook.misc.optional')}}</span>
                                    ...
                                    <div class="py-1">
                                        <span class="px-1 text-sm text-gray-600">{{__('kidbook.kid.bio')}} {{__('(optional)')}}</span>
