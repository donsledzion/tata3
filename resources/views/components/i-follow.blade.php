                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <button data-id="{{$family->permission(App\Models\User::find(\Illuminate\Support\Facades\Auth::id()))->id}}"
                                                    data-class="friends"
                                                    data-prompt="{{__('kidbook.prompt.question.unfollow')}}"
                                                    class="delete flex-no-shrink bg-red-500 hover:bg-red-600 px-1 ml-0 py-1 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-red-400 hover:border-red-600 text-white rounded-full transition ease-in duration-300">
